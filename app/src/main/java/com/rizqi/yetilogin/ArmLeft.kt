...
fun ArmLeft(drawScope: DrawScope) {
    ...
    val nailsPath = Path().apply {
        moveTo(178.8f, 74.7f)
        lineTo(181f, 74.1f)
        cubicTo(182.1f, 73.8f, 183.2f, 74.4f, 183.4f, 75.5f)
        cubicTo(183.7f, 76.6f, 182.9f, 77.7f, 181.8f, 77.9f)
        lineTo(179.6f, 78.5f)
        lineTo(178.6f, 74.7f)

        moveTo(180.1f, 64f)
        lineTo(182.3f, 63.4f)
        cubicTo(183.4f, 63.1f, 184.5f, 63.7f, 184.7f, 64.8f)
        cubicTo(185f, 65.9f, 184.2f, 67f, 183.1f, 67.2f)
        lineTo(180.9f, 67.8f)
        lineTo(180f, 64f)

        moveTo(175.5f, 54.9f)
        lineTo(177.7f, 54.3f)
        cubicTo(178.8f, 54f, 179.9f, 54.6f, 180.1f, 55.7f)
        cubicTo(180.4f, 56.8f, 179.6f, 57.9f, 178.5f, 58.1f)
        lineTo(176.3f, 58.7f)
        lineTo(175.4f, 54.9f)

        moveTo(152.1f, 49.4f)
        lineTo(154.3f, 48.8f)
        cubicTo(155.4f, 48.5f, 156.5f, 49.1f, 156.7f, 50.2f)
        cubicTo(157f, 51.3f, 156.2f, 52.4f, 155.1f, 52.6f)
        lineTo(152.9f, 53.2f)
        lineTo(152f, 49.4f)
    }
